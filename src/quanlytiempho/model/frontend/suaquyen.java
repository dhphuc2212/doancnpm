...
public class suaquyen extends javax.swing.JFrame {

    private int maquyen;
    private String tenquyen;
    private String ghichu;
    public suaquyen() throws SQLException {
        initComponents();
    ...
    public suaquyen(int maquyen,String tenquyen,String ghichu)
    {
        initComponents();
        this.setSize(600,400);
        this.setLocationRelativeTo(null);
        ...
        this.ghichu=ghichu;
        j1.setText(String.valueOf(this.maquyen));
        j1.setEditable(false);
        j2.setText(this.tenquyen);
        j3.setText(this.ghichu);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       {    qlpq.update(maquyen, tenquyen, ghichu);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(suaquyen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new suaquyen().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(suaquyen.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
