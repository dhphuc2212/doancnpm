...
public class themloaimonphu extends javax.swing.JFrame {

    /**
     * Creates new form themloaimonphu
     */
    public themloaimonphu() {
        initComponents();
  ...
  int id=Integer.parseInt(j1.getText());
        ...
        {
        qllmp.add(new loaimonphu(id,tenloai));
        JOptionPane.showMessageDialog(this,"Đã thêm loại món thành công.");
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(themloaimonphu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
