...
public class suataikhoan1 extends javax.swing.JFrame {
...
private String idtaikhoan;
  ...
  private int maquyen;
   ...
   public suataikhoan1(String idtaikhoan,String tentaikhoan,String matkhau,String idnhanvien,int maquyen)
   {   initComponents();
       ...
       j1.setText(this.idtaikhoan);
       j1.setEditable(false);
       j2.setText(this.matkhau);
       j3.setText(this.tentaikhoan);
       j4.setText(this.idnhanvien);
       j5.setText(String.valueOf(this.maquyen));
   }
    ...
    try {
        ...
        int maquyen=Integer.parseInt(j5.getText());
    
        if(idtaikhoan==""||tentaikhoan==""||matkhau==""||idnhanvien=="")
        {
            JOptionPane.showMessageDialog(this,"Không được để trống thông tin.");
        }
        else
        {
            tk.update(idtaikhoan,tentaikhoan,matkhau,idnhanvien,maquyen);
            JOptionPane.showMessageDialog(this,"Đã cập nhật dữ liệu thành công");
        }
    } catch (NoSuchAlgorithmException ex) {
        Logger.getLogger(suataikhoan1.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(suataikhoan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new suataikhoan1().setVisible(true);
            }
        });
    }
